---
title: "Bibliometric analysis for publications related to measurement error in geometric morphometrics"
...
The dataset used in this analysis was harvested from [Scopus](https://www.elsevier.com/solutions/scopus), includes all works recovered using the query "measurement error" AND "geometric morphometric," and was analysed using the `bibliometrix` package [@RN20997].
